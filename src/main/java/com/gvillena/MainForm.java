...
public class MainForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jBComprar.setFont(new java.awt.Font("Berlin Sans FB Demi", 1, 20)); // NOI18N
...
//        }
    ...
    String tplan=spPlanesPostpago.getValue().toString();
// TODO add your handling code here:
        Modulo_de_Pago modulo = new Modulo_de_Pago();
        modulo. setVisible(true);
        this.setVisible(false);
        
        Modulo_de_Pago.jTFImporteTotal.setText(lblPrecio.getText());
         Modulo_de_Pago.jTFPlan.setText(tplan);
          Modulo_de_Pago.jTFEquipo.setText(lblDescripcion.getText());
        
        
        /*Modulo_de_Pago g = new Modulo_de_Pago();
        g.setCadena(.getText);
        g.setVisible(true);
